...
export default function StoriesSection() {
  ...
  if (loading) {
    return (
      <div className="w-full bg-[hsl(var(--background))] border-b border-[hsl(var(--border))]/50 py-4.5 select-none overflow-x-hidden">
        <div className="mx-auto max-w-6xl px-5 sm:px-8 flex gap-4 overflow-x-auto scrollbar-none">
          {Array.from({ length: 6 }).map((_, idx) => (
            <div key={idx} className="flex flex-col items-center gap-2 shrink-0 animate-pulse">
              <div className="w-16 h-16 rounded-full bg-[hsl(var(--muted))]/70" />
              <div className="w-12 h-2 rounded bg-[hsl(var(--muted))]/70" />
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <div className="w-full bg-[hsl(var(--background))] border-b border-[hsl(var(--border))]/40 py-4.5 select-none relative z-10">
      <div className="mx-auto max-w-6xl px-5 sm:px-8 flex items-center gap-4 overflow-x-auto scrollbar-none py-1">
