...
export const ru: Translations = {
  locationPicker: {
    ...
    searchAddress: "Поиск адреса в Армении...",
    cancel: "Отмена",
    confirmLocation: "Подтвердить местоположение",
    moveMapHint: "Переместите карту и нажмите на точное место.",
    detecting: "Определение адреса...",
    clickToSet: "Нажмите на карту, чтобы установить местоположение",
  ...
  dashboard: {
    ...
    locations: {
      ...
      branchNameLabel: "Название филиала / Метка",
      branchNamePlaceholder: "напр. Центральный филиал",
      cityRegion: "Город / Регион",
      selectCity: "Выбрать город",
      streetAddress: "Адрес (улица)",
      streetAddressPlaceholder: "напр. ул. Туманяна 15",
      phone: "Телефон",
      setPrimary: "Установить как основное местоположение",
      pinOnMap: "Отметить на карте",
      searchAddress: "Искать адрес в Армении...",
      clickMapToSet: "Нажмите на карту, чтобы установить местоположение",
      cancel: "Отменить",
    ...
    settingsPage: {
      ...
      settingsPreferencesDesc: "Управление настройками рабочей области, параметрами API для разработчиков, учетными данными безопасности и встраиваниями",
      settingsSection: "Раздел настроек",
      accountProfile: "Профиль аккаунта",
      accountProfileDesc: "Обновите параметры вашего профиля, видимые во всех списках.",
    },
    inquiriesPage: {
      title: "Запросы",
    ...
    exchangeOffers: {
      ...
      categories: {
        ...
        "Drink": "Напиток",
        "Hookah": "Кальян",
        "Alcohol / Bar": "Алкоголь / Бар",
        "Coffee & Tea": "Кофе и Чай",
        "Desserts / Pastry": "Десерты / Выпечка",
        "Snacks / Finger Food": "Закуски",
        "Cigars & Tobacco": "Сигары и Табак",
        "Board Games / Gaming": "Настольные Игры"
      },
  ...
  builder: {
    ...
    stories: {
      ...
      selectFromArchive: "Выбрать истории из архива",
      storiesSelected: "Выбранные истории",
      updateHighlight: "Обновить Актуальное",
      publishHighlight: "Опубликовать Актуальное",
