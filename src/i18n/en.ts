export const en = {
  ...
  auth: {
    ...
    pwdUpper: " uppercase letter (A-Z)",
    pwdNumber: " number (0-9)",
    pwdSymbol: " special symbol (!@#$%^&*)",
  ...
  dashboard: {
    ...
    exchangeOffers: {
      ...
      categories: {
        ...
        "Snacks / Finger Food": "Snacks / Finger Food",
        "Cigars & Tobacco": "Cigars & Tobacco",
        "Board Games / Gaming": "Board Games / Gaming"
      },
  ...
  register: {
    ...
    selectUsername: "Select Username Login *",
    usernamePlaceholder: "e.g. aram_petrosyan",
    accountEmail: "Account Email address *",
    emailPlaceholder: "aram@domain.am",
    accountPassword: "Account Password *",
    confirmPassword: "Confirm Password *",
    businessNameLabel: "Business Name / Brand *",
    businessNamePlaceholder: "e.g. Lavash Restaurant, Grand Auto Service",
    industryCategory: "Industry Category *",
    businessDescLabel: "Business Description / Summary *",
    businessDescPlaceholder: "Describe what your business does, key products/services, etc. (required)",
    foundedYearText: "Founded Year",
    cityLabel: "City *",
    mapPicker: "Interactive Map Location Picker",
    addressDetails: "Address details",
    addressPlaceholder: "Address resolved from map or custom details",
    contactPhone: "Contact Phone *",
    contactEmailLabel: "Contact Email *",
    websiteOptional: "Website link (optional)",
    oneDigitMissing: "1 digit missing",
    digitsMissing: "digits missing",
    registering: "Registering...",
    completeActivate: "Complete & Activate Listing",
    onboardingComplete: "Onboarding Complete!",
    onboardingDesc: "Your brand profile and user credentials have been registered. You can now sign in at any time to modify details.",
    statusLabel: "Status",
    pendingApprovalStatus: "Pending Approval",
    returnHome: "Return Home",
    partnerOnboarding: "Partner Onboarding",
    onboardingSub: "Complete 4 simple steps to list your brand in the Armenian Business Directory",
    nextStep: "Next Step",
  ...
  builder: {
    ...
    stories: {
      ...
      selectFromArchive: "Select stories from archive",
  ...
  billing: {
    confirmChange: {
      ...
      warning: "You are about to change your current subscription plan. Please note that any prepaid balance for the unused period of your active plan is non-refundable and cannot be transferred to the new plan.",
      agree: "I acknowledge and agree to these terms",
      confirm: "Proceed to Payment",
      cancel: "Cancel",
    },
    alreadySubscribed: "You are already a user of this plan",
    title: "Billing & Plans",
    ...
    receipts: {
      ...
      confirmDeleteSelected: "Are you sure you want to delete the selected transactions?",
      confirmDeleteSingle: "Are you sure you want to delete this transaction?",
      cancel: "Cancel",
      plan: "PLAN",
      amount: "AMOUNT",
      date: "DATE",
