...
import { Monitor, Wheat, UtensilsCrossed, ShoppingBag, Building2, Landmark, Heart, GraduationCap, ArrowRight } from "lucide-react";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Categories — ArmenBiz Hub",
  description: "Browse Armenian businesses by industry: Technology, Agriculture, HoReCa, Retail, Construction, Finance, Healthcare, and Education.",
};
